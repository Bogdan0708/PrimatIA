    ...
    <div className="space-y-6">
      ...
      <HclEditForm
        hcl={{
          ...
          title: hcl.title,
          inflationIndex: hcl.inflationIndex != null ? Number(hcl.inflationIndex) : null,
          bonificatieProcent: hcl.bonificatieProcent != null ? Number(hcl.bonificatieProcent) : null,
