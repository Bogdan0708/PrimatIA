...
const adminNavItems: NavItem[] = [
  {
    ...
    icon: Scale,
    roles: ["super_admin", "primaria_admin", "operator"],
  },
  {
    href: "/imports",
    labelKey: "imports",
  ...
  {
    href: "/configuration/hcl-decisions",
    labelKey: "hclDecisions",
    icon: ClipboardList,
    roles: ["super_admin", "primaria_admin"],
  },
  {
    href: "/configuration/rate-tables",
    labelKey: "rateTables",
    icon: ScrollText,
    roles: ["super_admin", "primaria_admin"],
  },
  {
    href: "/configuration/exemptions",
    labelKey: "exemptions",
    icon: Shield,
    roles: ["super_admin", "primaria_admin"],
  },
